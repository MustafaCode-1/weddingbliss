  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Everything you need to know for our special day. From ceremony details to travel information, 
              we've got you covered for a perfect celebration.
            </p>
          </div>
      ...
      <div className="fixed bottom-6 right-6 z-40">
        <button className="w-14 h-14 bg-primary text-primary-foreground rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 flex items-center justify-center">
